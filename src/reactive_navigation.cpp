...
int main(int argc, char **argv){
  ...
  ros::Subscriber laser_sub_0 = n.subscribe("/base_scan_0", 100, laserCallback);
  ros::Subscriber laser_sub_1 = n.subscribe("/base_scan_1", 100, laserCallback);
  ros::Subscriber laser_sub_2 = n.subscribe("/base_scan_2", 100, laserCallback);
